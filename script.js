...
const sendMessage = () => {
  ...
  var visitorEmail = document.getElementById("txtEmail").value;
  var visitorFeedback = document.getElementById("txtFeedback").value;

  alert(`Name: ${visitorName}\nEmail: ${visitorEmail}\nFeedback: ${visitorFeedback}`);
};
...
function toggleClick() {
  ...
  ToggleButton.addEventListener("DOMContentLoaded", function(){
